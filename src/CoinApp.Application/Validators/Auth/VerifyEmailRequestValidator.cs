...
public sealed class VerifyEmailRequestValidator : AbstractValidator<VerifyEmailRequest>
{
    public VerifyEmailRequestValidator()
    {
        ...
        RuleFor(x => x.Code)
            .NotEmpty()
            .WithMessage("validation.auth_email_verification_code_required")
            .Length(6)
            .WithMessage("validation.auth_email_verification_code_length")
            .Matches("^[0-9]{6}$")
            .WithMessage("validation.auth_email_verification_code_format");
    }
}
